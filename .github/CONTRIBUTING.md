...
Love docs and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/ethjs/docs/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git remote add upstream https://github.com/ethjs/docs.git
   ```
...
**DESIGN NOTE**: docs follows the UNIX programming philosophy. Please consider this before contributing, keep your commits/modules concise and to the point.
